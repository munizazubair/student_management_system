...
if (enrollAns.enroll == "yes") {
  ...
  let basicCourseFees: number = 5000;
  let htmlCourseFees: number = 10000;
  let cssCourseFees: number = 20000;
  let jsCourseFees: number = 25000;

  if (coursesName.courses == "Basic Course") {
    console.log(
      `Basic Course Info: They cover basic computer skills, such as using an operating sysytems, navigating the web, and working with basic software applications \n Monthly Course Fee: ${basicCourseFees}`
    );
  } else if (coursesName.courses == "HTML Course") {
    console.log(
      `HTML COurse Info: In 'Hypertext Marlup Language'you'll learn how to structure web pages and create content. \n Monthly Course Fee: ${htmlCourseFees} `
    );
  } else if (coursesName.courses == "CSS Course") {
    console.log(
      `CSS Course Info: In 'Cascading Style Sheets' you will learn how to make your web pages visually appealing with control over layout ,colours, fonts, etc \n Monthly Course Fee: ${cssCourseFees}`
    );
  } else if (coursesName.courses == "JS Course") {
    console.log(
      `JS Course Information: In 'Javascript' you will learn how to add functionality and interactivity to your web pages, making them more dynamic and attractive \n Monthly Course Fee: ${jsCourseFees}`
    );
  }
